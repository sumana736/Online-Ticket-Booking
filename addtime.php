...
<!-- Right side column. Contains the navbar and content of the page -->
      <div class="content-wrapper">
			...
			if(isset($_POST["sub"]))
		{
			$a=$_POST["sn"];
			$b=$_POST["t"];
				$selectexist="select * from time where stationname='$a' and trainid='$tid'"; 
		$resexist=mysqli_query($conn,$selectexist); 
		$rc=mysqli_num_rows($resexist); 
		if($rc==0)
			{
				$queryinsert="insert into time values('','$tid','$a','$b')";
			   ...
			   <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
					...
					<?php
					$c=1;
						$queryselect="select * from time where trainid='$tid'";
					...
					?>
							...
							<td><?php echo $a;?></td>
							<td><?php echo $b;?></td>
							<td><a href="timedelete.php?s=<?php echo $c;?>"><img src="img/delete.png" width="30px" height="30px"></a></td>
							</tr>
							<?php
						}
