          ...
          <div class="row">
				...
				if(isset($_POST["add"]))
			{
				...
				$c=$_POST["scode"];
					...
					$queryinsert="insert into busstopage values('','$a','$b','$c')";
					if(mysqli_query($conn,$queryinsert))
					{
						echo'Stopage Added successfully';

					}
					else
					{
						echo'Stopage not Added';
					}
			}
			?>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
						...
						<td><a href="stopageedit.php?e=<?php echo $a;?>"> <img src="img/edit.png" width="50px" height="30px"> </a></td>
						<td><a href="stopagedelete.php?e=<?php echo $a;?>"> <img src="img/delete.png" width="30px" height="30px"> </a></td>
						</tr>
						<?php
						}
						?>
