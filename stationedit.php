...
<!-- Right side column. Contains the navbar and content of the page -->
      <div class="content-wrapper">
		...
		if(isset($_POST["edit"]))
		{
			...
			$b=$_POST["sname"];
			$c=$_POST["scode"];
			$queryinsert="update station set City='$a',stationname='$b',stationcode='$c' where stationid='$s'";
			if(mysqli_query($conn,$queryinsert))
			{
				echo"<script>alert('Data inserted');window.location.href='addstation.php'</script>";
			}
			else
			{
				echo"<script>alert('Data not inserted');window.location.href='addstation.php'</script>";
			}
		}
	?>	
