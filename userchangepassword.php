        ...
        <section class="content">
          <div class="row">
			...
			if(isset($_POST["change"]))
			{
				...
				$z=$_POST["repassword"];
				$e=$_SESSION['email'];
				$selectupdate="select * from user where email='$e' and password='$x'";
				$resupdate=mysqli_query($conn,$selectupdate);
				$rc=mysqli_num_rows($resupdate);
				if($rc==1)
				{
					$queryinsert="update user set password='$y' where email='$e'";
					...
					{
						echo"<script>alert('Password has not Changed!!!');window.location.href='userdashboard.php'</script>";
					}
				}
			}
			?>
